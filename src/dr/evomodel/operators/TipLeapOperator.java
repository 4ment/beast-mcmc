...
public class TipLeapOperator extends AbstractTreeOperator implements CoercableMCMCOperator {
     ...
     */
    public TipLeapOperator(TreeModel tree, Taxa taxa, double weight, double size, double accP, CoercionMode mode) {
        this.tree = tree;
        setWeight(weight);
        this.size = size;
        this.accP = accP;
